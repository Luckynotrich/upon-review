...
// insert into public.user(user_name, email, password) values ('luckiest', 'luckiest@lucky.com', 'luckies');  
 const UserContext = createContext();
 export const UserContextProvider = ({ children }) => {
    const [userId, setUserId] = useState('3d99966d-b1ad-4ea4-bcdd-49062f2f3f1f');
